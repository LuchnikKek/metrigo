...
// 			return
// 		}
// 		if r.URL.Path != "/update/counter/PollCount/10" && r.URL.Path != "/update/gauge/RandomValue/0.1234" {
// 			w.WriteHeader(http.StatusNotFound)
// 			return
// 		}
// 		w.WriteHeader(http.StatusOK)
...
// 	err := ag.Send("PollCount", 10, string(models.Counter))
// 	require.NoError(t, err)

// 	err = ag.Send("RandomValue", 0.1234, string(models.Gauge))
// 	require.NoError(t, err)
// }
